    ...
    function drawGrid(progress) {
        ...
        for (let i = 0; i < rows; i++) {
            for (let j = 0; j < cols; j++) {
                ...
                const intensity =
                    Math.sin(progress * Math.PI * 2 + delay) * 0.5 + 0.5;
                    ...
                    >
                        <div className="text-center space-y-6 sm:space-y-8 max-w-4xl">
                            ...
                            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed max-w-3xl">
                                ...
                                . I'm a data analyist and developer passionate
                                about building intelligent systems and exploring
                                the intersection of AI and technology. My work
                                focuses on building and deploying intelligent,
                                production-ready systems at the intersection of
                                AI, cloud infrastructure, and modern web.
                            </p>
                        </div>
                    </section>
